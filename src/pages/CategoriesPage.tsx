...
import { mockCategories, mockDomainAccesses } from '../data/mockData';
    ...
    <Grid size={{ xs: 12, md: 5 }}>
      <PageSection title="Distribuicao por categoria">
        <ResponsiveContainer width="100%" height={300}>
          <PieChart>
            <Pie data={mockCategories} dataKey="accessCount" nameKey="displayName" outerRadius={100}>
          ...
          {mockCategories.map((category) => (
            <Stack key={category.name} spacing={1} sx={{ border: '1px solid', borderColor: 'divider', borderRadius: 1, p: 2 }}>
              ...
              {mockDomainAccesses
                ...
                .map((domain) => (
                  <Typography key={domain.localId} variant="body2" color="text.secondary">
